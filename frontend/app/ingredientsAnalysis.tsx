...
const Analysis = () => {
  ...
  const fetchIngredients = async () => {
    const API_URL =
      "http://13.229.232.103:3000/api/v1/products/1/confidence?product_name=The Face Shop Rice Water Cleansing Oil";
    try {
      ...
      >
        ...
        <View style={styles.page} key="1">
          <View style={styles.topHalf}>
            <View style={{ display: "flex", alignItems: "center" }}>
              <Text style={{ fontSize: 22, fontWeight: "700" }}>
                Reviews from individuals who share similar skin conditions and
                have previously tried this product
              </Text>
            </View>
            <View>
              <View style={styles.effectiveness}>
                ...
                >
                  <View>
                    ...
                    >
                      <Image
                        source={require("../assets/images/3stars.png")}
                      ></Image>
                    ...
                    >
                      <Image
                        source={require("../assets/images/2stars.png")}
                      ></Image>
                    ...
                    >
                      <Image
                        source={require("../assets/images/1stars.png")}
                      ></Image>
                ...
                >
                  ...
                  ></Image>
                  <Text>
                    {percentageNegativeReactions}% experienced negative
                    reactions
                  </Text>
                </View>
              </View>
